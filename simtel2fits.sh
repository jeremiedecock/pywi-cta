...
./pywicta/io/simtel_to_fits.py --max-images 10000 --min-npe 50  --max-npe 2000 --min-ellipticity 0.1 --max-ellipticity 0.6 --max-radius 0.9036 --camid LSTCam --time-slices -o ${ROOT_OUTPUT_DIR}/lst        ~/data/grid_prod3b_north/simtel/gamma/gamma_20deg_0deg_run104___cta-prod3-lapalma3-2147m-LaPalma.simtel.gz
...
./pywicta/io/simtel_to_fits.py --max-images 10000 --min-npe 50  --max-npe 2000 --min-ellipticity 0.1 --max-ellipticity 0.6 --max-radius 0.906 --camid NectarCam --time-slices -o ${ROOT_OUTPUT_DIR}/nectarcam        ~/data/grid_prod3b_north/simtel/gamma/gamma_20deg_0deg_run104___cta-prod3-lapalma3-2147m-LaPalma.simtel.gz
...
./pywicta/io/simtel_to_fits.py --max-images 10000 --min-npe 40  --max-npe 2000 --min-ellipticity 0.1 --max-ellipticity 0.6 --max-radius 0.357 --camid DigiCam --time-slices -o ${ROOT_OUTPUT_DIR}/sst1m        ~/data/sst1m_mini_array_konrad/simtel/sst1m/gamma/gamma_20deg_180deg_run2203___cta-prod3-sst-dc_desert-2150m-Paranal-sst-dc.simtel.gz
...
./pywicta/io/simtel_to_fits.py --max-images 10000 --min-npe 40  --max-npe 2000 --min-ellipticity 0.1 --max-ellipticity 0.6 --max-radius 0.125 --camid CHEC --time-slices -o ${ROOT_OUTPUT_DIR}/gct        ~/data/sst1m_mini_array_konrad/simtel/sst1m/gamma/gamma_20deg_180deg_run2203___cta-prod3-sst-dc_desert-2150m-Paranal-sst-dc.simtel.gz
...
./pywicta/io/simtel_to_fits.py --max-images 10000 --min-npe 50  --max-npe 2000 --min-ellipticity 0.1 --max-ellipticity 0.6 --max-radius 0.14 --camid ASTRICam --time-slices -o ${ROOT_OUTPUT_DIR}/astri        ~/data/sst1m_mini_array_konrad/simtel/sst1m/gamma/gamma_20deg_180deg_run2203___cta-prod3-sst-dc_desert-2150m-Paranal-sst-dc.simtel.gz
